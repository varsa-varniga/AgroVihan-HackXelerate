...
const Details = () => {
  ...
  // const [openTrainingDialog, setOpenTrainingDialog] = useState(false); // Removed training dialog state
  ...
  // const handleOpenTrainingDialog = () => { // Removed training dialog handlers
  ...
  // Fetch employees when the component mounts or the district ID changes
  useEffect(() => {
    fetchEmployees();
  }, [id]);
